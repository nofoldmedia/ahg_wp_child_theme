...
<div class="template-partial-footer__contact-information-group">


        
            
                
                <h3 class="template-partial-footer__list-title"><strong>Contact</strong></h3>

    <ul>

        <li  class="template-partial-footer__contact-information-list-item">
