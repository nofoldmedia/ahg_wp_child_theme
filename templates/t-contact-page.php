...
// get_template_part( 'template-partials-sections/t-p-section-frontpage-columns-5050-text-image' );
...
// :: Template partial  sections : Columns 40/60
// get_template_part( 'template-partials-sections/t-p-section-frontpage-columns-4060' );
